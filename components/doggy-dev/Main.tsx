...
import {
  Review,
  ReviewSummary,
} from "@/components/doggy-dev/reviews/ReviewSummary";
import { Contact } from "@/components/doggy-dev/Contact";
import { Reviews } from "@/components/doggy-dev/reviews/Reviews";
  ...
  return (
    <div className="w-full">
      ...
      <div ref={homeRef} className="flex flex-col mt-32 scroll-m-[128px]">
        <div className="bg-fixed bg-center md:bg-top bg-cover bg-[url('../public/images/background-1.jpg')] bg-no-repeat md:h-[800px]">
          <div
